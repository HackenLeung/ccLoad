...
func DefineChannelModelsTable() *TableBuilder {
	return NewTable("channel_models").
		...
		Column("vision_assist_enabled TINYINT NOT NULL DEFAULT 0").
		Column("vision_pool_enabled TINYINT NOT NULL DEFAULT 0").
		Column("vision_priority INT NOT NULL DEFAULT 0").
