...
type Store interface {
	...
	ReplaceVisionPool(ctx context.Context, updates []model.VisionPoolUpdate) error
	...
	GetCumulativeStats(ctx context.Context, filter *model.LogFilter) ([]model.StatsEntry, error)
