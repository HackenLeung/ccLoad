...
const (
	...
	githubDownloadBaseURL       = "https://github.com/HackenLeung/ccLoad/releases/download"
	ghproxyLatestReleaseURL     = "https://ghproxy.net/https://github.com/HackenLeung/ccLoad/releases/latest"
	ghproxyDownloadBaseURL      = "https://ghproxy.net/https://github.com/HackenLeung/ccLoad/releases/download"
