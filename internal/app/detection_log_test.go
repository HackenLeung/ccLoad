...
func TestDetectionLogFromResult_AllowsNilConfig(t *testing.T) {
	...
	entry := detectionLogFromResult(nil, model.LogSourceManualTest, "request-model", "actual-model", "sk-test", nil, 42, "", map[string]any{
		"status_code":            200,
...
func TestDetectionLogFromResult_NormalizesOpenAIChatMixedUsage(t *testing.T) {
	...
	entry := detectionLogFromResult(cfg, model.LogSourceManualTest, "mimo-v2.5", "", "sk-test", nil, 0, "", map[string]any{
		"status_code": 200,
...
func TestDetectionLogFromResult_UsesRequestThinkingEffort(t *testing.T) {
	...
	entry := detectionLogFromResult(nil, model.LogSourceManualTest, "gpt-5.5", "", "sk-test", nil, 0, "High", map[string]any{
		"status_code": 200,
		"message":     "API测试成功",
	})
...
func TestDetectionLogFromResult_UpstreamThinkingEffortOverridesRequest(t *testing.T) {
	...
	entry := detectionLogFromResult(nil, model.LogSourceManualChat, "gpt-5.5", "", "sk-test", nil, 0, "low", map[string]any{
		"status_code": 200,
		"api_response": map[string]any{
