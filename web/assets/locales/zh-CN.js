...
window.I18N_LOCALES['zh-CN'] = {
  ...
  'channels.sortBtn': '排序',
  'channels.sortPreset': '排序方案',
  'channels.sortPresetDefault': '默认排序',
  'channels.saveSortPreset': '保存方案',
  'channels.saveSortPresetTitle': '保存当前排序为方案',
  ...
  'channels.sortPresetCreateHint': '填写名称后，可把当前拖拽顺序保存为新方案',
  'channels.sortPresetUpdateHint': '当前会更新已选方案；修改名称可重命名',
  'channels.sortPresetNamePrompt': '请输入排序方案名称',
  'channels.sortPresetSaved': '排序方案已保存',
  'channels.sortPresetApplied': '排序方案已应用',
  'channels.sortPresetApplyFailed': '应用排序方案失败',
