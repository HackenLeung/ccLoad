...
window.I18N_LOCALES['en'] = {
  ...
  'channels.sortPreset': 'Sort Preset',
  'channels.sortPresetDefault': 'Default',
  'channels.saveSortPreset': 'Save Preset',
  'channels.saveSortPresetTitle': 'Save current order as a preset',
  ...
  'channels.sortPresetCreateHint': 'Enter a name to save the dragged order as a new preset',
  'channels.sortPresetUpdateHint': 'This will update the selected preset; edit the name to rename it',
  'channels.sortPresetNamePrompt': 'Enter a sort preset name',
  'channels.sortPresetSaved': 'Sort preset saved',
  'channels.sortPresetApplied': 'Sort preset applied',
  'channels.sortPresetApplyFailed': 'Failed to apply sort preset',
